      ...
      <>
        <span className="inline-flex align-baseline">
          <div
            ...
            className={cn(
              'relative inline-block w-fit max-w-full justify-center overflow-clip rounded border border-border-gray bg-brand/80 px-1 font-normal text-fg-secondary shadow-xs transition-all',
