...
import { mockAssembly, mockRepo, resetAssemblyMocks } from '@/test/mocks'
...
describe('SegmentsService', () => {
  ...
  // ── Auth guards: only internal users can manage segments ──────────
  ...
  // ── Segment config lock: can't change config while segments exist ─
  ...
  // ── resolveSetting: the core segmentation algorithm ───────────────
